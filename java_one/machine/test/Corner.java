...
public class Corner {
	public static void main(String[] args) throws Exception {
		...
		canvas.init(Arrays.asList(
			Arrays.asList(  lf, f13,  lf, f13,  lf,  lf,  lf ),
			Arrays.asList(  sn, f13, f13, f13, f13, f13, f13 ),
			Arrays.asList(  lf,  lf, f13,  lf, f13,  f2,  lf ),
			Arrays.asList(  lf,  lf,  lf, f13, f13,  lf,  lf ),
			Arrays.asList(  lf,  lf,  lf,  lf, f13, f13,  lf ),
			Arrays.asList(  lf,  lf,  lf, f13, f13,  lf,  lf ),
			Arrays.asList(  lf,  lf,  lf,  lf, f13,  lf,  lf )
		));
